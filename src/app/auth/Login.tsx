...
const Login = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-tl from-indigo-950 via-black to-indigo-950 flex items-center justify-center p-4 relative">
            <div className={`relative ${isOpen ? 'mr-60' : ''} animate-pulse-shadow`}>
                <BorderBeam
                    className='absolute top-0 left-0 w-full h-full rounded-2xl'
                    size={100}
                    duration={5}
                    delay={0}
                    colorTo='oklch(62.7% 0.265 303.9)'
                    borderWidth={1}
                    colorFrom='oklch(51.1% 0.262 276.966)'
                />
                <div className="bg-gradient-to-br from-indigo-800 via-black/30 to-black rounded-l-lg p-6 ">
                    {/* Header */}
                    <div className="flex items-center justify-between w-full mb-6 ">
                        ...
                        <div className="flex items-center gap-2">
                            <button onClick={togglePanel} className='bg-indigo-950 hover:bg-indigo-800 hover:text-white backdrop-blur-sm border border-indigo-800 rounded-xl p-1.5 text-white cursor-pointer'>
                                <Icon icon="mdi:qrcode" className="w-6 h-6 " />
                            </button>
                        </div>
                    </div>
